...
/**
 * This program takes vectors are produced by the C program word2vec and
 * transforms them into a Java binary file to be read by the Vectors class
 */
public class ConvertVectors {
	...
	public static void main(String[] args) throws VectorsException, IOException {
		...
		System.out.println("" + words + " words with size " + size
				+ " per vector.");
		...
		for (int w = 0; w < words; w++) {
			...
			for (int i = 0; i < size; i++) {
				// read a little endian floating point number and interpret it
				// as a big endian one, see
				...
				buf[0] = orig[2];
				buf[3] = orig[3];
				// this code can be made more efficient by reusing the
